...
import { Box, Layers, Hash, Wrench, Building2, FileCheck, CheckCircle2, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 p-5 sm:p-6 shadow-sm">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 mb-4 border-b border-slate-100 gap-2">
        <div>
          <h3 className="text-xs sm:text-sm font-bold text-[#0B192C] uppercase tracking-wide flex items-center">
            <Box className="w-4 h-4 mr-2 text-[#0067C5]" />
            Requirement Understanding & Parameter Breakdown
          </h3>
          <p className="text-xs text-slate-500 mt-0.5">
            Structured parameters extracted from natural language. Explicit values are distinguished from inferred product domains.
          </p>
        </div>

        <div className="flex items-center space-x-2 text-[10px] font-semibold">
          <span className="inline-flex items-center px-2 py-0.5 rounded bg-blue-50 text-[#0067C5] border border-blue-200">
            <span className="w-1.5 h-1.5 rounded-full bg-[#0067C5] mr-1.5"></span>
            EXPLICIT
          </span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 text-xs">
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-100 flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500 mb-1">
            <span className="font-semibold flex items-center">
              <Box className="w-3.5 h-3.5 mr-1.5 text-[#0067C5]" />
              Target Product
            </span>
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-100 flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500 mb-1">
            <span className="font-semibold flex items-center">
              <Hash className="w-3.5 h-3.5 mr-1.5 text-[#0067C5]" />
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-100 flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500 mb-1">
            <span className="font-semibold flex items-center">
              <Wrench className="w-3.5 h-3.5 mr-1.5 text-[#0067C5]" />
              Specifications & Capacity
            </span>
            <span className="text-[9px] px-1.5 py-0.2 rounded font-bold bg-blue-100 text-blue-700">
              EXPLICIT
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-100 flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500 mb-1">
            <span className="font-semibold flex items-center">
              <Building2 className="w-3.5 h-3.5 mr-1.5 text-[#0067C5]" />
              Installation Type
            </span>
            <span className="text-[9px] px-1.5 py-0.2 rounded font-bold bg-blue-100 text-blue-700">
              EXPLICIT
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-100 flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500 mb-1">
            <span className="font-semibold flex items-center">
              <FileCheck className="w-3.5 h-3.5 mr-1.5 text-[#0067C5]" />
              Application & Context
            </span>
            <span className="text-[9px] px-1.5 py-0.2 rounded font-bold bg-blue-100 text-blue-700">
              EXPLICIT
      ...
      {data.explicitly_mentioned_standards.length > 0 && (
        <div className="mt-4 p-3 rounded-xl bg-blue-50/70 border border-blue-200 flex flex-wrap items-center justify-between text-xs gap-2">
          <div className="flex items-center space-x-2 text-blue-900">
            <CheckCircle2 className="w-4 h-4 text-[#0067C5] flex-shrink-0" />
            <span>
        ...
        return (
          <div className="mt-4 pt-3 border-t border-slate-100 flex flex-wrap items-center justify-between gap-2 text-xs">
            <div className="flex items-center space-x-1.5 text-slate-500 font-medium">
              ...
              <span>Unspecified Parameters in Requirement:</span>
            </div>

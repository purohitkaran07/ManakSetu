  ...
  return (
    <div className="h-full flex flex-col bg-white border-l border-slate-200 shadow-xl overflow-y-auto">
      ...
      <div className="p-5 space-y-5 text-xs">
        ...
        {/* Scope */}
        <div>
          <h4 className="font-bold text-[#0B192C] uppercase tracking-wider text-[11px] mb-1.5 flex items-center">
            <FileText className="w-3.5 h-3.5 mr-1 text-[#0067C5]" />
            Official Standard Scope
          </h4>
          <p className="text-slate-600 leading-relaxed bg-slate-50 p-3 rounded-xl border border-slate-200 line-clamp-6">
            {standard.scope}
          </p>
        </div>
        ...
        <div>
          <h4 className="font-bold text-[#0B192C] uppercase tracking-wider text-[11px] mb-2 flex items-center">
            <Network className="w-3.5 h-3.5 mr-1 text-[#0067C5]" />
          ...
          {standard.relationships.length === 0 ? (
            ...
            <div className="space-y-2">
              {standard.relationships.map((rel) => (
                <div
                  key={rel.id}
                  className="p-3 rounded-xl border border-slate-200 bg-white hover:border-blue-300 transition shadow-2xs space-y-1.5"
                >
                  ...
                  <button
                    ...
                    className="w-full mt-1.5 py-1 px-2 rounded bg-slate-50 hover:bg-blue-50 text-[#0067C5] font-bold text-[11px] border border-slate-200 hover:border-blue-200 transition flex items-center justify-center cursor-pointer"
                  >
        ...
        <div className="pt-2">
          <Link
            ...
            className="w-full flex items-center justify-center px-4 py-2.5 rounded-xl bg-[#0B192C] hover:bg-[#004C99] text-white font-bold text-xs shadow-sm transition"
          >
